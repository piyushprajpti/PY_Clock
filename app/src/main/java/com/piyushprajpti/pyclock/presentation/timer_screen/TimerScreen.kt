...
import com.piyushprajpti.pyclock.presentation.stopwatch_screen.LapCard
import com.piyushprajpti.pyclock.presentation.stopwatch_screen.LapSectionHeader
import com.piyushprajpti.pyclock.presentation.stopwatch_screen.formatElapsedTime
...
fun TimerScreen(isDarkTheme: Boolean) {
    ...
    val elapsedTimeText = remember { mutableStateOf("00:15:00") }
